        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                ->addColumn('action', function ($item) {
                    return '
                        <a class="inline-block border-none bg-violet-500 text-white rounded-md px-4 py-1 m-1 font-semibold transition duration-500 ease select-none hover:bg-violet-800 focus:outline-none focus:shadow-outline"
