    ...
    <section class="bg-gray-100 py-8 px-4">
        <div class="container mx-auto">
            <ul class="breadcrumb">
                ...
                <li>
                    <p class="font-semibold">Shopping Cart</p>
                </li>
            </ul>
        </div>
    </section>
                        ...
                        <div class="flex flex-start flex-wrap items-center mb-4 -mx-4" data-row="1">
                            <div class="px-4 flex-none">
                                <div class="" style="width: 90px; height: 90px">
                                    <img
                                        src="{{ $cart->product->galleries()->exists() ? \Illuminate\Support\Facades\Storage::url($cart->product->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                            ...
                            <div class="px-4 w-auto flex-none md:flex-1 md:w-5/12 hidden md:block">
                                <div class="">
                                    <h6 class="font-semibold text-lg">
                                        IDR {{ number_format($cart->product->price, 0, ',' ,'.') }}</h6>
                                </div>
                            </div>
                            <div class="px-4 w-2/12">
                                <div class="text-center">
                    ...
                    <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
                        <form action="{{ route('checkout') }}" method="POST">
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input data-input type="email" name="email" id="email" placeholder="julianne@gmail.com"
                                       class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                                />
                            </div>
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input data-input type="text" name="address" id="address"
                                       placeholder="Jl. Melati No.58, RT.8/RW.7, Ragunan, Ps. Minggu, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12550"
                                       class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                                />
                            </div>
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input data-input type="text" name="phone" id="phone-number" placeholder="08512345xxxx"
                                       class="border-gray-200 border rounded-lg px-4 py-2 bg-white text-sm focus:border-blue-200 focus:outline-none"
                                />
                            </div>
