                        ...
                        @foreach($product->galleries as $item)
                            <div class="px-2">
                                <div
                                        ...
                                        data-img="{{ \Illuminate\Support\Facades\Storage::url($item->url) }}"
                                >
                                    <img
                    ...
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <img
                                        src="{{ $recommendation->galleries()->exists() ? \Illuminate\Support\Facades\Storage::url($recommendation->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                                        alt="image {{ $recommendation->slug}}"
